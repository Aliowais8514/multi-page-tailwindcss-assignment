...
const Watches = () => { // Changed 'watches' to 'Watches' to follow React's naming convention
    ...
    <div className="watches grid grid-cols-1 md:grid-cols-3 gap-10 px-10 my-10" data-aos="fade-up">
      {watchesData.map((watch) => (
        <div key={watch.id} className="watch-card bg-white p-5 rounded-md shadow-md text-center" data-aos="fade-up">
          ...
          <button className="mt-4 hover:bg-blue-600 transform transition-all duration-300 hover:scale-110 bg-blue-500 px-8 py-2 text-white rounded-full border-none" data-aos="fade-up">
            Add to Cart
          </button>
        </div>
      ))}
...
export default Watches; // Exported 'Watches' component
